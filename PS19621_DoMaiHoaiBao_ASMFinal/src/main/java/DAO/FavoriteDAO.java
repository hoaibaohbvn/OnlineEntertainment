...
public class FavoriteDAO {
	...
	public List<FavoriteReport>reportFavoritesByVideos(){
		String jpql = "select new com.poly.servlet.common.FavoriteReport(f.video.title,count(f),min(f.likeDate),max(f.likeDate)) "
	...
	public List<FavoriteUserReport> reportFavoriteUsersByVideos(String id){
		String jpql="select new com.poly.servlet.common.FavoriteUserReport(f.user.id,f.user.fullname,"
